...
$qJadwal = ($role==='admin') ?
    ...
    :
    mysqli_query($koneksi, "SELECT j.*, u.username FROM jadwal_kegiatan j JOIN user u ON j.dibuat_oleh=u.id_user WHERE j.dibuat_oleh='$id_user_session' ORDER BY tanggal, waktu");
?>
